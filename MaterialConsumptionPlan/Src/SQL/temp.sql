...
SELECT ID,
  PLANT,
  MATERIAL,
  AVG26_USAGE_QTY AS C1090_26AVG_USAGE_QTY
FROM INV_SAP_PP_OPT_X
WHERE PLANT  IN ('1090')
AND MATERIAL IN ('889D-F5AC-10 B')

SELECT ID,
  PLANT,
  MATERIAL,
  AVG26_USAGE_QTY AS k_26AVG_USAGE_QTY
FROM INV_SAP_PP_OPT_X
WHERE PLANT  IN ('5100')
AND MATERIAL IN ('889D-F5AC-10 B')
...
SELECT 
  MATERIAL,
  SUM(AVG26_USAGE_QTY) AS AP_AVG26_USAGE_QTY
FROM INV_SAP_PP_OPT_X
...
ON DELI.ID = SO.ID) WHERE SALES_DOC = '6501921250'


SELECT * FROM INV_SAP_LIKP_LIPS_DAILY_6MM WHERE DELIVERY = '8014274637'
