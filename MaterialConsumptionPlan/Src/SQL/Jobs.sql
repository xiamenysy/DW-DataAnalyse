...
SELECT * FROM DWQ$LIBRARIAN.INV_SAP_PP_PARAM@ROCKWELL_DBLINK WHERE PLANTID IN ('5040', '5050', '5100', '5110', '5120', '5160', '5190', '5200','5070','5140');


DROP TABLE INV_SAP_INVENTORY_WKS;
CREATE TABLE INV_SAP_INVENTORY_WKS AS
SELECT * FROM DWQ$LIBRARIAN.INV_SAP_INVENTORY_WKS@ROCKWELL_DBLINK WHERE PLANTID IN ('5040', '5050', '5100', '5110', '5120', '5160', '5190', '5200','5070','5140');
...
FROM
  (SELECT MATERIALID
    ...
    DIRECT_SHIP_PLANT,
    CURRENT_SERIES
  FROM INV_SAP_PP_MVKE where MATERIALID = 'PN-C36042'
...
SELECT * FROM VIEW_INV_SAP_PP_OPT_X WHERE ID = 'PN-C36042_5040';
...
FROM
  ...
  FROM
    (SELECT MATERIALID
      ...
      (1.4*GRT + PDT)   AS LEAD_TIME,  --Lead Time Change!!
...
SELECT PP_BASIC.ID,
  ...
  FROM
    (SELECT MATERIALID
      ...
      PROD_SCHED_FEVOR  AS PROD_SCHED_KEY,
      REORDER_PT        AS RECORDER_POINT,
      (1.4*GRT + PDT)   AS LEAD_TIME,   ---Lead Time Change, from GRT+PDT+1 to 1.4*GRT + PDT
      MEINS_ISSUE_UOM   AS UNIT,
      ISSUE_UOM_NUMERATOR,
      PO_UOM_NUMERATOR,
      MATL_TYPE_MTART AS MATL_TYPE,
