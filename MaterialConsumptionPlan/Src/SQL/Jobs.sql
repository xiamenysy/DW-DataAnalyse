...
SELECT * FROM INV_SAP_PP_PO_HISTORY WHERE MATERIALID = 'PN-219818' AND PLANTID = '5040'
...
SELECT PP_BASIC.ID,
  ...
  FROM
    (SELECT MATERIALID
      ...
      PROD_SCHED_FEVOR  AS PROD_SCHED_KEY,
      REORDER_PT        AS RECORDER_POINT,
      CEIL(1.4*GRT + PDT)   AS LEAD_TIME,   ---Lead Time Change, from GRT+PDT+1 to 1.4*GRT + PDT
      MEINS_ISSUE_UOM   AS UNIT,
      ISSUE_UOM_NUMERATOR,
      PO_UOM_NUMERATOR,
      MATL_TYPE_MTART AS MATL_TYPE,
