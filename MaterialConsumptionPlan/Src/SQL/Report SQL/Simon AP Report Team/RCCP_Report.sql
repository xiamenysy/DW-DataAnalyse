...
DROP VIEW VIEW_INV_SAP_RCCP_B_FIRM;
	...
	SELECT * FROM INV_SAP_IO_INPUTS_DAILY WHERE MATERIALID = '100-C09D10 A' AND PLANTID = '5040'
	-------------------------REPORT----------------------------
--RCCP REPORT
DROP VIEW VIEW_INV_SAP_RCCP;
...
SELECT RCCP_BS_IND_FIRM_PLAN.ID            AS ID,
  ...
  NVL(RCCP_BS_IND_FIRM_PLAN.TOT_Req_Week_1,0)     AS TOT_Req_Week_1,
  NVL(RCCP_BS_IND_FIRM_PLAN.TOT_Req_Week_2,0)     AS TOT_Req_Week_2,
  NVL(RCCP_BS_IND_FIRM_PLAN.TOT_Req_Week_3,0)     AS TOT_Req_Week_3,
  NVL(RCCP_BS_IND_FIRM_PLAN.TOT_Req_Week_4,0)     AS TOT_Req_Week_4,
  NVL(RCCP_BS_IND_FIRM_PLAN.TOT_Req_Week_5,0)     AS TOT_Req_Week_5,
  NVL(RCCP_BS_IND_FIRM_PLAN.TOT_Req_Week_6,0)     AS TOT_Req_Week_6,
  NVL(RCCP_BS_IND_FIRM_PLAN.TOT_Req_Week_7,0)     AS TOT_Req_Week_7,
  NVL(RCCP_BS_IND_FIRM_PLAN.TOT_Req_Week_8,0)     AS TOT_Req_Week_8,
  NVL(RCCP_BS_IND_FIRM_PLAN.TOT_Req_Week_9,0)     AS TOT_Req_Week_9,
  NVL(RCCP_BS_IND_FIRM_PLAN.TOT_Req_Week_10,0)    AS TOT_Req_Week_10,
  NVL(RCCP_BS_IND_FIRM_PLAN.TOT_Req_Week_11,0)    AS TOT_Req_Week_11,
  NVL(RCCP_BS_IND_FIRM_PLAN.TOT_Req_Week_12,0)    AS TOT_Req_Week_12,
  NVL(RCCP_BS_IND_FIRM_PLAN.TOT_Req_Week_13,0)    AS TOT_Req_Week_13,
  RCCP_BS_IND_FIRM_PLAN.Three_Sigma        AS Three_Sigma,
  RCCP_BS_IND_FIRM_PLAN.Three_Sigma_Load   AS Three_Sigma_Load,
  NVL(RCCP_BS_IND_FIRM_PLAN.TOT_PO_PLO_Week_1,0)  AS TOT_PO_PLO_Week_1,
  NVL(RCCP_BS_IND_FIRM_PLAN.TOT_PO_PLO_Week_2,0)  AS TOT_PO_PLO_Week_2,
  NVL(RCCP_BS_IND_FIRM_PLAN.TOT_PO_PLO_Week_3,0)  AS TOT_PO_PLO_Week_3,
  NVL(RCCP_BS_IND_FIRM_PLAN.TOT_PO_PLO_Week_4,0)  AS TOT_PO_PLO_Week_4,
  NVL(RCCP_BS_IND_FIRM_PLAN.TOT_PO_PLO_Week_5,0)  AS TOT_PO_PLO_Week_5,
  NVL(RCCP_BS_IND_FIRM_PLAN.TOT_PO_PLO_Week_6,0)  AS TOT_PO_PLO_Week_6,
  NVL(RCCP_BS_IND_FIRM_PLAN.TOT_PO_PLO_Week_7,0)  AS TOT_PO_PLO_Week_7,
  NVL(RCCP_BS_IND_FIRM_PLAN.TOT_PO_PLO_Week_8,0)  AS TOT_PO_PLO_Week_8,
  NVL(RCCP_BS_IND_FIRM_PLAN.TOT_PO_PLO_Week_9,0)  AS TOT_PO_PLO_Week_9,
  NVL(RCCP_BS_IND_FIRM_PLAN.TOT_PO_PLO_Week_10,0) AS TOT_PO_PLO_Week_10,
  NVL(RCCP_BS_IND_FIRM_PLAN.TOT_PO_PLO_Week_11,0)AS TOT_PO_PLO_Week_11,
  NVL(RCCP_BS_IND_FIRM_PLAN.TOT_PO_PLO_Week_12,0) AS TOT_PO_PLO_Week_12,
  NVL(RCCP_BS_IND_FIRM_PLAN.TOT_PO_PLO_Week_13,0) AS TOT_PO_PLO_Week_13,
