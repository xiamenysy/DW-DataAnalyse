...
SELECT * FROM INV_SAP_RCCP where id = '100-C09D10 A_5040';
...
SELECT RCCP.ID        AS ID,
  ...
  FIRM_REQ_OPEN_PO.OPEN_PLAN_WEEK_2        AS OPEN_PLAN_WEEK_2,
  FIRM_REQ_OPEN_PO.OPEN_PLAN_WEEK_3        AS OPEN_PLAN_WEEK_3,
  FIRM_REQ_OPEN_PO.OPEN_PLAN_WEEK_4        AS OPEN_PLAN_WEEK_4,
  FIRM_REQ_OPEN_PO.OPEN_PLAN_WEEK_5        AS OPEN_PLAN_WEEK_5,
  FIRM_REQ_OPEN_PO.OPEN_PLAN_WEEK_6        AS OPEN_PLAN_WEEK_6,
  FIRM_REQ_OPEN_PO.OPEN_PLAN_WEEK_7        AS OPEN_PLAN_WEEK_7,
  FIRM_REQ_OPEN_PO.OPEN_PLAN_WEEK_8        AS OPEN_PLAN_WEEK_8,
  FIRM_REQ_OPEN_PO.OPEN_PLAN_WEEK_9        AS OPEN_PLAN_WEEK_9,
  FIRM_REQ_OPEN_PO.OPEN_PLAN_WEEK_10       AS OPEN_PLAN_WEEK_10,
  FIRM_REQ_OPEN_PO.OPEN_PLAN_WEEK_11       AS OPEN_PLAN_WEEK_11,
  FIRM_REQ_OPEN_PO.OPEN_PLAN_WEEK_12       AS OPEN_PLAN_WEEK_12,
  FIRM_REQ_OPEN_PO.OPEN_PLAN_WEEK_13       AS OPEN_PLAN_WEEK_13


--- VIEW_INV_SAP_RCCP_BASIC
 DROP VIEW VIEW_INV_SAP_RCCP_BASIC; 
--VIEW_INV_SAP_RCCP_BASIC+PO
--VIEW_INV_SAP_RCCP_B_PO
DROP VIEW VIEW_INV_SAP_RCCP_B_PO;


--VIEW_INV_SAP_RCCP_B_PL
DROP VIEW VIEW_INV_SAP_RCCP_B_PL;

--VIEW_INV_SAP_RCCP_B_FIRM
DROP VIEW VIEW_INV_SAP_RCCP_B_FIRM;
...
SELECT RCCP_BS_IND_FIRM_PLAN.ID            AS ID,
  ...
  RCCP_BS_IND_FIRM_PLAN.Ind_Req_Week_1     AS Ind_Req_Week_1,
  RCCP_BS_IND_FIRM_PLAN.Ind_Req_Week_2     AS Ind_Req_Week_2,
  RCCP_BS_IND_FIRM_PLAN.Ind_Req_Week_3     AS Ind_Req_Week_3,
  RCCP_BS_IND_FIRM_PLAN.Ind_Req_Week_4     AS Ind_Req_Week_4,
  RCCP_BS_IND_FIRM_PLAN.Ind_Req_Week_5     AS Ind_Req_Week_5,
  RCCP_BS_IND_FIRM_PLAN.Ind_Req_Week_6     AS Ind_Req_Week_6,
  RCCP_BS_IND_FIRM_PLAN.Ind_Req_Week_7     AS Ind_Req_Week_7,
  RCCP_BS_IND_FIRM_PLAN.Ind_Req_Week_8     AS Ind_Req_Week_8,
  RCCP_BS_IND_FIRM_PLAN.Ind_Req_Week_9     AS Ind_Req_Week_9,
  RCCP_BS_IND_FIRM_PLAN.Ind_Req_Week_10    AS Ind_Req_Week_10,
  RCCP_BS_IND_FIRM_PLAN.Ind_Req_Week_11    AS Ind_Req_Week_11,
  RCCP_BS_IND_FIRM_PLAN.Ind_Req_Week_12    AS Ind_Req_Week_12,
  RCCP_BS_IND_FIRM_PLAN.Ind_Req_Week_13    AS Ind_Req_Week_13,
  RCCP_BS_IND_FIRM_PLAN.FIRM_REQ_WEEK_1    AS FIRM_REQ_WEEK_1,
  RCCP_BS_IND_FIRM_PLAN.FIRM_REQ_WEEK_2    AS FIRM_REQ_WEEK_2,
  RCCP_BS_IND_FIRM_PLAN.FIRM_REQ_WEEK_3    AS FIRM_REQ_WEEK_3,
  RCCP_BS_IND_FIRM_PLAN.FIRM_REQ_WEEK_4    AS FIRM_REQ_WEEK_4,
  RCCP_BS_IND_FIRM_PLAN.FIRM_REQ_WEEK_5    AS FIRM_REQ_WEEK_5,
  RCCP_BS_IND_FIRM_PLAN.FIRM_REQ_WEEK_6    AS FIRM_REQ_WEEK_6,
  RCCP_BS_IND_FIRM_PLAN.FIRM_REQ_WEEK_7    AS FIRM_REQ_WEEK_7,
  RCCP_BS_IND_FIRM_PLAN.FIRM_REQ_WEEK_8    AS FIRM_REQ_WEEK_8,
  RCCP_BS_IND_FIRM_PLAN.FIRM_REQ_WEEK_9    AS FIRM_REQ_WEEK_9,
  RCCP_BS_IND_FIRM_PLAN.FIRM_REQ_WEEK_10   AS FIRM_REQ_WEEK_10,
  RCCP_BS_IND_FIRM_PLAN.FIRM_REQ_WEEK_11   AS FIRM_REQ_WEEK_11,
  RCCP_BS_IND_FIRM_PLAN.FIRM_REQ_WEEK_12   AS FIRM_REQ_WEEK_12,
  RCCP_BS_IND_FIRM_PLAN.FIRM_REQ_WEEK_13   AS FIRM_REQ_WEEK_13,
  RCCP_BS_IND_FIRM_PLAN.TOT_Req_Week_1     AS TOT_Req_Week_1,
  RCCP_BS_IND_FIRM_PLAN.TOT_Req_Week_2     AS TOT_Req_Week_2,
  RCCP_BS_IND_FIRM_PLAN.TOT_Req_Week_3     AS TOT_Req_Week_3,
  RCCP_BS_IND_FIRM_PLAN.TOT_Req_Week_4     AS TOT_Req_Week_4,
  RCCP_BS_IND_FIRM_PLAN.TOT_Req_Week_5     AS TOT_Req_Week_5,
  RCCP_BS_IND_FIRM_PLAN.TOT_Req_Week_6     AS TOT_Req_Week_6,
  RCCP_BS_IND_FIRM_PLAN.TOT_Req_Week_7     AS TOT_Req_Week_7,
  RCCP_BS_IND_FIRM_PLAN.TOT_Req_Week_8     AS TOT_Req_Week_8,
  RCCP_BS_IND_FIRM_PLAN.TOT_Req_Week_9     AS TOT_Req_Week_9,
  RCCP_BS_IND_FIRM_PLAN.TOT_Req_Week_10    AS TOT_Req_Week_10,
  RCCP_BS_IND_FIRM_PLAN.TOT_Req_Week_11    AS TOT_Req_Week_11,
  RCCP_BS_IND_FIRM_PLAN.TOT_Req_Week_12    AS TOT_Req_Week_12,
  RCCP_BS_IND_FIRM_PLAN.TOT_Req_Week_13    AS TOT_Req_Week_13,
  RCCP_BS_IND_FIRM_PLAN.Three_Sigma        AS Three_Sigma,
  RCCP_BS_IND_FIRM_PLAN.Three_Sigma_Load   AS Three_Sigma_Load,
  RCCP_BS_IND_FIRM_PLAN.TOT_PO_PLO_Week_1  AS TOT_PO_PLO_Week_1,
  RCCP_BS_IND_FIRM_PLAN.TOT_PO_PLO_Week_2  AS TOT_PO_PLO_Week_2,
  RCCP_BS_IND_FIRM_PLAN.TOT_PO_PLO_Week_3  AS TOT_PO_PLO_Week_3,
  RCCP_BS_IND_FIRM_PLAN.TOT_PO_PLO_Week_4  AS TOT_PO_PLO_Week_4,
  RCCP_BS_IND_FIRM_PLAN.TOT_PO_PLO_Week_5  AS TOT_PO_PLO_Week_5,
  RCCP_BS_IND_FIRM_PLAN.TOT_PO_PLO_Week_6  AS TOT_PO_PLO_Week_6,
  RCCP_BS_IND_FIRM_PLAN.TOT_PO_PLO_Week_7  AS TOT_PO_PLO_Week_7,
  RCCP_BS_IND_FIRM_PLAN.TOT_PO_PLO_Week_8  AS TOT_PO_PLO_Week_8,
  RCCP_BS_IND_FIRM_PLAN.TOT_PO_PLO_Week_9  AS TOT_PO_PLO_Week_9,
  RCCP_BS_IND_FIRM_PLAN.TOT_PO_PLO_Week_10 AS TOT_PO_PLO_Week_10,
  RCCP_BS_IND_FIRM_PLAN.TOT_PO_PLO_Week_11 AS TOT_PO_PLO_Week_11,
  RCCP_BS_IND_FIRM_PLAN.TOT_PO_PLO_Week_12 AS TOT_PO_PLO_Week_12,
  RCCP_BS_IND_FIRM_PLAN.TOT_PO_PLO_Week_13 AS TOT_PO_PLO_Week_13,
  ...
  OPEN_PO.OPEN_OP_WEEK_13                            AS OPEN_OP_WEEK_13,
  RCCP_BS_IND_FIRM_PLAN.OPEN_PLAN_WEEK_1               AS OPEN_PLAN_WEEK_1,
  RCCP_BS_IND_FIRM_PLAN.OPEN_PLAN_WEEK_2               AS OPEN_PLAN_WEEK_2,
  RCCP_BS_IND_FIRM_PLAN.OPEN_PLAN_WEEK_3               AS OPEN_PLAN_WEEK_3,
  RCCP_BS_IND_FIRM_PLAN.OPEN_PLAN_WEEK_4               AS OPEN_PLAN_WEEK_4,
  RCCP_BS_IND_FIRM_PLAN.OPEN_PLAN_WEEK_5               AS OPEN_PLAN_WEEK_5,
  RCCP_BS_IND_FIRM_PLAN.OPEN_PLAN_WEEK_6               AS OPEN_PLAN_WEEK_6,
  RCCP_BS_IND_FIRM_PLAN.OPEN_PLAN_WEEK_7               AS OPEN_PLAN_WEEK_7,
  RCCP_BS_IND_FIRM_PLAN.OPEN_PLAN_WEEK_8               AS OPEN_PLAN_WEEK_8,
  RCCP_BS_IND_FIRM_PLAN.OPEN_PLAN_WEEK_9               AS OPEN_PLAN_WEEK_9,
  RCCP_BS_IND_FIRM_PLAN.OPEN_PLAN_WEEK_10              AS OPEN_PLAN_WEEK_10,
  RCCP_BS_IND_FIRM_PLAN.OPEN_PLAN_WEEK_11              AS OPEN_PLAN_WEEK_11,
  RCCP_BS_IND_FIRM_PLAN.OPEN_PLAN_WEEK_12              AS OPEN_PLAN_WEEK_12,
  RCCP_BS_IND_FIRM_PLAN.OPEN_PLAN_WEEK_13              AS OPEN_PLAN_WEEK_13
FROM
  (SELECT RCCP_BS_IND_FIRM.ID           AS ID,
    ...
    RCCP_BS_IND_FIRM.TOT_Req_Week_1     AS TOT_Req_Week_1,
    RCCP_BS_IND_FIRM.TOT_Req_Week_2     AS TOT_Req_Week_2,
    RCCP_BS_IND_FIRM.TOT_Req_Week_3     AS TOT_Req_Week_3,
    RCCP_BS_IND_FIRM.TOT_Req_Week_4     AS TOT_Req_Week_4,
    RCCP_BS_IND_FIRM.TOT_Req_Week_5     AS TOT_Req_Week_5,
    RCCP_BS_IND_FIRM.TOT_Req_Week_6     AS TOT_Req_Week_6,
    RCCP_BS_IND_FIRM.TOT_Req_Week_7     AS TOT_Req_Week_7,
    RCCP_BS_IND_FIRM.TOT_Req_Week_8     AS TOT_Req_Week_8,
    RCCP_BS_IND_FIRM.TOT_Req_Week_9     AS TOT_Req_Week_9,
    RCCP_BS_IND_FIRM.TOT_Req_Week_10    AS TOT_Req_Week_10,
    RCCP_BS_IND_FIRM.TOT_Req_Week_11    AS TOT_Req_Week_11,
    RCCP_BS_IND_FIRM.TOT_Req_Week_12    AS TOT_Req_Week_12,
    RCCP_BS_IND_FIRM.TOT_Req_Week_13    AS TOT_Req_Week_13,
    RCCP_BS_IND_FIRM.Three_Sigma        AS Three_Sigma,
    RCCP_BS_IND_FIRM.Three_Sigma_Load   AS Three_Sigma_Load,
    RCCP_BS_IND_FIRM.TOT_PO_PLO_Week_1  AS TOT_PO_PLO_Week_1,
    RCCP_BS_IND_FIRM.TOT_PO_PLO_Week_2  AS TOT_PO_PLO_Week_2,
    RCCP_BS_IND_FIRM.TOT_PO_PLO_Week_3  AS TOT_PO_PLO_Week_3,
    RCCP_BS_IND_FIRM.TOT_PO_PLO_Week_4  AS TOT_PO_PLO_Week_4,
    RCCP_BS_IND_FIRM.TOT_PO_PLO_Week_5  AS TOT_PO_PLO_Week_5,
    RCCP_BS_IND_FIRM.TOT_PO_PLO_Week_6  AS TOT_PO_PLO_Week_6,
    RCCP_BS_IND_FIRM.TOT_PO_PLO_Week_7  AS TOT_PO_PLO_Week_7,
    RCCP_BS_IND_FIRM.TOT_PO_PLO_Week_8  AS TOT_PO_PLO_Week_8,
    RCCP_BS_IND_FIRM.TOT_PO_PLO_Week_9  AS TOT_PO_PLO_Week_9,
    RCCP_BS_IND_FIRM.TOT_PO_PLO_Week_10 AS TOT_PO_PLO_Week_10,
    RCCP_BS_IND_FIRM.TOT_PO_PLO_Week_11 AS TOT_PO_PLO_Week_11,
    RCCP_BS_IND_FIRM.TOT_PO_PLO_Week_12 AS TOT_PO_PLO_Week_12,
    RCCP_BS_IND_FIRM.TOT_PO_PLO_Week_13 AS TOT_PO_PLO_Week_13,
  ...
  FROM
    (SELECT RCCP_BASIC_IND.ID           AS ID,
      ...
      RCCP_BASIC_IND.TOT_Req_Week_1     AS TOT_Req_Week_1,
      RCCP_BASIC_IND.TOT_Req_Week_2     AS TOT_Req_Week_2,
      RCCP_BASIC_IND.TOT_Req_Week_3     AS TOT_Req_Week_3,
      RCCP_BASIC_IND.TOT_Req_Week_4     AS TOT_Req_Week_4,
      RCCP_BASIC_IND.TOT_Req_Week_5     AS TOT_Req_Week_5,
      RCCP_BASIC_IND.TOT_Req_Week_6     AS TOT_Req_Week_6,
      RCCP_BASIC_IND.TOT_Req_Week_7     AS TOT_Req_Week_7,
      RCCP_BASIC_IND.TOT_Req_Week_8     AS TOT_Req_Week_8,
      RCCP_BASIC_IND.TOT_Req_Week_9     AS TOT_Req_Week_9,
      RCCP_BASIC_IND.TOT_Req_Week_10    AS TOT_Req_Week_10,
      RCCP_BASIC_IND.TOT_Req_Week_11    AS TOT_Req_Week_11,
      RCCP_BASIC_IND.TOT_Req_Week_12    AS TOT_Req_Week_12,
      RCCP_BASIC_IND.TOT_Req_Week_13    AS TOT_Req_Week_13,
      RCCP_BASIC_IND.Three_Sigma        AS Three_Sigma,
      RCCP_BASIC_IND.Three_Sigma_Load   AS Three_Sigma_Load,
      RCCP_BASIC_IND.TOT_PO_PLO_Week_1  AS TOT_PO_PLO_Week_1,
      RCCP_BASIC_IND.TOT_PO_PLO_Week_2  AS TOT_PO_PLO_Week_2,
      RCCP_BASIC_IND.TOT_PO_PLO_Week_3  AS TOT_PO_PLO_Week_3,
      RCCP_BASIC_IND.TOT_PO_PLO_Week_4  AS TOT_PO_PLO_Week_4,
      RCCP_BASIC_IND.TOT_PO_PLO_Week_5  AS TOT_PO_PLO_Week_5,
      RCCP_BASIC_IND.TOT_PO_PLO_Week_6  AS TOT_PO_PLO_Week_6,
      RCCP_BASIC_IND.TOT_PO_PLO_Week_7  AS TOT_PO_PLO_Week_7,
      RCCP_BASIC_IND.TOT_PO_PLO_Week_8  AS TOT_PO_PLO_Week_8,
      RCCP_BASIC_IND.TOT_PO_PLO_Week_9  AS TOT_PO_PLO_Week_9,
      RCCP_BASIC_IND.TOT_PO_PLO_Week_10 AS TOT_PO_PLO_Week_10,
      RCCP_BASIC_IND.TOT_PO_PLO_Week_11 AS TOT_PO_PLO_Week_11,
      RCCP_BASIC_IND.TOT_PO_PLO_Week_12 AS TOT_PO_PLO_Week_12,
      RCCP_BASIC_IND.TOT_PO_PLO_Week_13 AS TOT_PO_PLO_Week_13,
