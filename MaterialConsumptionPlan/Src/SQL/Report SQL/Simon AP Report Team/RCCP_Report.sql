...
CREATE VIEW VIEW_INV_SAP_RCCP AS 
  SELECT RCCP.ID      AS ID,
    ...
    RCCP.Ind_Req_AVG_50,
    RCCP.Ind_Req_AVG_25,
    RCCP.Ind_Req_Week_1       AS Ind_Req_Week_1,
    RCCP.Ind_Req_Week_2       AS Ind_Req_Week_2,
    RCCP.Ind_Req_Week_3       AS Ind_Req_Week_3,
    RCCP.Ind_Req_Week_4       AS Ind_Req_Week_4,
    RCCP.Ind_Req_Week_5       AS Ind_Req_Week_5,
    RCCP.Ind_Req_Week_6       AS Ind_Req_Week_6,
    RCCP.Ind_Req_Week_7       AS Ind_Req_Week_7,
    RCCP.Ind_Req_Week_8       AS Ind_Req_Week_8,
    RCCP.Ind_Req_Week_9       AS Ind_Req_Week_9,
    RCCP.Ind_Req_Week_10      AS Ind_Req_Week_10,
    RCCP.Ind_Req_Week_11      AS Ind_Req_Week_11,
    RCCP.Ind_Req_Week_12      AS Ind_Req_Week_12,
    RCCP.Ind_Req_Week_13      AS Ind_Req_Week_13,
    FIRM_REQ.FIRM_REQ_WEEK_01 AS FIRM_REQ_WEEK_01,
    FIRM_REQ.FIRM_REQ_WEEK_02 AS FIRM_REQ_WEEK_02,
    FIRM_REQ.FIRM_REQ_WEEK_03 AS FIRM_REQ_WEEK_03,
    FIRM_REQ.FIRM_REQ_WEEK_04 AS FIRM_REQ_WEEK_04,
    FIRM_REQ.FIRM_REQ_WEEK_05 AS FIRM_REQ_WEEK_05,
    FIRM_REQ.FIRM_REQ_WEEK_06 AS FIRM_REQ_WEEK_06,
    FIRM_REQ.FIRM_REQ_WEEK_07 AS FIRM_REQ_WEEK_07,
    FIRM_REQ.FIRM_REQ_WEEK_08 AS FIRM_REQ_WEEK_08,
    FIRM_REQ.FIRM_REQ_WEEK_09 AS FIRM_REQ_WEEK_09,
    ...
    RCCP.TOT_Req_Week_1       AS TOT_Req_Week_1,
    RCCP.TOT_Req_Week_2       AS TOT_Req_Week_2,
    RCCP.TOT_Req_Week_3       AS TOT_Req_Week_3,
    RCCP.TOT_Req_Week_4       AS TOT_Req_Week_4,
    RCCP.TOT_Req_Week_5       AS TOT_Req_Week_5,
    RCCP.TOT_Req_Week_6       AS TOT_Req_Week_6,
    RCCP.TOT_Req_Week_7       AS TOT_Req_Week_7,
    RCCP.TOT_Req_Week_8       AS TOT_Req_Week_8,
    RCCP.TOT_Req_Week_9       AS TOT_Req_Week_9,
    RCCP.TOT_Req_Week_10      AS TOT_Req_Week_10,
    RCCP.TOT_Req_Week_11      AS TOT_Req_Week_11,
    RCCP.TOT_Req_Week_12      AS TOT_Req_Week_12,
    RCCP.TOT_Req_Week_13      AS TOT_Req_Week_13,
    RCCP.Three_Sigma,
    RCCP.Three_Sigma_Load,
    RCCP.TOT_PO_PLO_Week_1  AS TOT_PO_PLO_Week_1,
    RCCP.TOT_PO_PLO_Week_2  AS TOT_PO_PLO_Week_2,
    RCCP.TOT_PO_PLO_Week_3  AS TOT_PO_PLO_Week_3,
    RCCP.TOT_PO_PLO_Week_4  AS TOT_PO_PLO_Week_4,
    RCCP.TOT_PO_PLO_Week_5  AS TOT_PO_PLO_Week_5,
    RCCP.TOT_PO_PLO_Week_6  AS TOT_PO_PLO_Week_6,
    RCCP.TOT_PO_PLO_Week_7  AS TOT_PO_PLO_Week_7,
    RCCP.TOT_PO_PLO_Week_8  AS TOT_PO_PLO_Week_8,
    RCCP.TOT_PO_PLO_Week_9  AS TOT_PO_PLO_Week_9,
    RCCP.TOT_PO_PLO_Week_10 AS TOT_PO_PLO_Week_10,
    RCCP.TOT_PO_PLO_Week_11 AS TOT_PO_PLO_Week_11,
    RCCP.TOT_PO_PLO_Week_12 AS TOT_PO_PLO_Week_12,
    RCCP.TOT_PO_PLO_Week_13 AS TOT_PO_PLO_Week_13
  FROM
    (SELECT RCCP_BASIC.ID          AS ID,
      RCCP_BASIC.LAST_REVIEW       AS LAST_REVIEW,
      RCCP_BASIC.MATERIAL          AS MATERIAL,
