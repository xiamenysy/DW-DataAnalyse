...
SELECT * FROM VIEW_INV_SAP_RCCP WHERE plant = '5040' and material = '1756-IB16 A';
...
SELECT * FROM VIEW_INV_SAP_RCCP where id = '1756-IB16 A_5040';
...
SELECT RCCP.ID        AS ID,
  ...
  FIRM_REQ_OPEN_PO.OPEN_PLAN_WEEK_1       AS OPEN_PLAN_WEEK_1,
