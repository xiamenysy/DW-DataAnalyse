...
BS_MCBZ_PO.ID         AS ID,
  ...
  BS_MCBZ_PO.MAT_DESC        AS MATERIAL_DES,
  ...
  BS_MCBZ_PO.MAX_INV         AS MAX_INV,
          ...
          0               AS Ind_Req_AVG_50,
          0               AS Ind_Req_AVG_25,
		    BS_MCBZ_PO.IND_REQ_WK_0    AS IND_REQ_WEEK_0,
  BS_MCBZ_PO.IND_REQ_WK_1    AS IND_REQ_WEEK_1,
  BS_MCBZ_PO.IND_REQ_WK_2    AS IND_REQ_WEEK_2,
  BS_MCBZ_PO.IND_REQ_WK_3    AS IND_REQ_WEEK_3,
  BS_MCBZ_PO.IND_REQ_WK_4    AS IND_REQ_WEEK_4,
  BS_MCBZ_PO.IND_REQ_WK_5    AS IND_REQ_WEEK_5,
  BS_MCBZ_PO.IND_REQ_WK_6    AS IND_REQ_WEEK_6,
  BS_MCBZ_PO.IND_REQ_WK_7    AS IND_REQ_WEEK_7,
  BS_MCBZ_PO.IND_REQ_WK_8    AS IND_REQ_WEEK_8,
  BS_MCBZ_PO.IND_REQ_WK_9    AS IND_REQ_WEEK_9,
  BS_MCBZ_PO.IND_REQ_WK_10   AS IND_REQ_WEEK_10,
  BS_MCBZ_PO.IND_REQ_WK_11   AS IND_REQ_WEEK_11,
  BS_MCBZ_PO.IND_REQ_WK_12   AS IND_REQ_WEEK_12,
    BS_MCBZ_PO.IND_REQ_WK_0      AS FIRM_REQ_WEEK_0,
  BS_MCBZ_PO.IND_REQ_WK_1      AS FIRM_REQ_WEEK_1,
  BS_MCBZ_PO.IND_REQ_WK_2      AS FIRM_REQ_WEEK_2,
  BS_MCBZ_PO.IND_REQ_WK_3      AS FIRM_REQ_WEEK_3,
  BS_MCBZ_PO.IND_REQ_WK_4      AS FIRM_REQ_WEEK_4,
  BS_MCBZ_PO.IND_REQ_WK_5      AS FIRM_REQ_WEEK_5,
  BS_MCBZ_PO.IND_REQ_WK_6      AS FIRM_REQ_WEEK_6,
  BS_MCBZ_PO.IND_REQ_WK_7      AS FIRM_REQ_WEEK_7,
  BS_MCBZ_PO.IND_REQ_WK_8      AS FIRM_REQ_WEEK_8,
  BS_MCBZ_PO.IND_REQ_WK_9      AS FIRM_REQ_WEEK_9,
  BS_MCBZ_PO.IND_REQ_WK_10     AS FIRM_REQ_WEEK_10,
  BS_MCBZ_PO.IND_REQ_WK_11     AS FIRM_REQ_WEEK_11,
  BS_MCBZ_PO.IND_REQ_WK_12     AS FIRM_REQ_WEEK_12,
    BS_MCBZ_PO.IND_REQ_WK_0    AS TOT_REQ_WEEK_0,
  BS_MCBZ_PO.IND_REQ_WK_1    AS TOT_REQ_WEEK_1,
  BS_MCBZ_PO.IND_REQ_WK_2    AS TOT_REQ_WEEK_2,
  BS_MCBZ_PO.IND_REQ_WK_3    AS TOT_REQ_WEEK_3,
  BS_MCBZ_PO.IND_REQ_WK_4    AS TOT_REQ_WEEK_4,
  BS_MCBZ_PO.IND_REQ_WK_5    AS TOT_REQ_WEEK_5,
  BS_MCBZ_PO.IND_REQ_WK_6    AS TOT_REQ_WEEK_6,
  BS_MCBZ_PO.IND_REQ_WK_7    AS TOT_REQ_WEEK_7,
  BS_MCBZ_PO.IND_REQ_WK_8    AS TOT_REQ_WEEK_8,
  BS_MCBZ_PO.IND_REQ_WK_9    AS TOT_REQ_WEEK_9,
  BS_MCBZ_PO.IND_REQ_WK_10   AS TOT_REQ_WEEK_10,
  BS_MCBZ_PO.IND_REQ_WK_11   AS TOT_REQ_WEEK_11,
  BS_MCBZ_PO.IND_REQ_WK_12   AS TOT_REQ_WEEK_12,
...
NVL(BS_MCBZ_PO.OPEN_OP_WEEK_12,0) + NVL(OPEN_PLAN.PLAN_OP_WEEK_12,0) AS TOT_PO_PLO_WEEK_12,
  ...
  BS_MCBZ_PO.OPEN_OP_WEEK_1 AS OPEN_OP_WEEK_0,                                                                                                                 AS OPEN_OP_WEEK_1,
  BS_MCBZ_PO.OPEN_OP_WEEK_2 AS OPEN_OP_WEEK_1,                                                                                                                         AS OPEN_OP_WEEK_2,
  BS_MCBZ_PO.OPEN_OP_WEEK_3 AS OPEN_OP_WEEK_2,                                                                                                                              AS OPEN_OP_WEEK_3,
  BS_MCBZ_PO.OPEN_OP_WEEK_4 AS OPEN_OP_WEEK_3,                                                                                                                              AS OPEN_OP_WEEK_4,
  BS_MCBZ_PO.OPEN_OP_WEEK_5 AS OPEN_OP_WEEK_4,                                                                                                                              AS OPEN_OP_WEEK_5,
  BS_MCBZ_PO.OPEN_OP_WEEK_6 AS OPEN_OP_WEEK_5,                                                                                                                              AS OPEN_OP_WEEK_6,
  BS_MCBZ_PO.OPEN_OP_WEEK_7 AS OPEN_OP_WEEK_6,                                                                                                                              AS OPEN_OP_WEEK_7,
  BS_MCBZ_PO.OPEN_OP_WEEK_8 AS OPEN_OP_WEEK_7,                                                                                                                              AS OPEN_OP_WEEK_8,
  BS_MCBZ_PO.OPEN_OP_WEEK_9 AS OPEN_OP_WEEK_8,                                                                                                                              AS OPEN_OP_WEEK_9,
  BS_MCBZ_PO.OPEN_OP_WEEK_10 AS OPEN_OP_WEEK_9,                                                                                                                             AS OPEN_OP_WEEK_10,
  BS_MCBZ_PO.OPEN_OP_WEEK_11 AS OPEN_OP_WEEK_10,                                                                                                                             AS OPEN_OP_WEEK_11,
  BS_MCBZ_PO.OPEN_OP_WEEK_12 AS OPEN_OP_WEEK_11,                                                                                                                             AS OPEN_OP_WEEK_12,
  BS_MCBZ_PO.OPEN_OP_WEEK_13 AS OPEN_OP_WEEK_12,

      OPEN_PLAN.PLAN_OP_WEEK_0  AS PLAN_OP_WEEK_0,
      OPEN_PLAN.PLAN_OP_WEEK_1  AS PLAN_OP_WEEK_1,
      OPEN_PLAN.PLAN_OP_WEEK_2  AS PLAN_OP_WEEK_2,
      OPEN_PLAN.PLAN_OP_WEEK_3  AS PLAN_OP_WEEK_3,
      OPEN_PLAN.PLAN_OP_WEEK_4  AS PLAN_OP_WEEK_4,
      OPEN_PLAN.PLAN_OP_WEEK_5  AS PLAN_OP_WEEK_5,
      OPEN_PLAN.PLAN_OP_WEEK_6  AS PLAN_OP_WEEK_6,
      OPEN_PLAN.PLAN_OP_WEEK_7  AS PLAN_OP_WEEK_7,
      OPEN_PLAN.PLAN_OP_WEEK_8  AS PLAN_OP_WEEK_8,
      OPEN_PLAN.PLAN_OP_WEEK_9 AS PLAN_OP_WEEK_9,
      OPEN_PLAN.PLAN_OP_WEEK_10 AS PLAN_OP_WEEK_10,
      OPEN_PLAN.PLAN_OP_WEEK_11 AS PLAN_OP_WEEK_11,
      OPEN_PLAN.PLAN_OP_WEEK_12 AS PLAN_OP_WEEK_12
FROM 
(
SELECT 

BS_MCBZ_TOT_IND_FIRM.ID         AS ID,
  ...
  BS_MCBZ_TOT_IND_FIRM.MAT_DESC        AS MATERIAL_DES,
  ...
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_0    AS TOT_REQ_WEEK_0,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_1    AS TOT_REQ_WEEK_1,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_2    AS TOT_REQ_WEEK_2,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_3    AS TOT_REQ_WEEK_3,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_4    AS TOT_REQ_WEEK_4,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_5    AS TOT_REQ_WEEK_5,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_6    AS TOT_REQ_WEEK_6,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_7    AS TOT_REQ_WEEK_7,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_8    AS TOT_REQ_WEEK_8,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_9    AS TOT_REQ_WEEK_9,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_10   AS TOT_REQ_WEEK_10,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_11   AS TOT_REQ_WEEK_11,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_12   AS TOT_REQ_WEEK_12,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_0    AS IND_REQ_WEEK_0,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_1    AS IND_REQ_WEEK_1,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_2    AS IND_REQ_WEEK_2,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_3    AS IND_REQ_WEEK_3,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_4    AS IND_REQ_WEEK_4,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_5    AS IND_REQ_WEEK_5,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_6    AS IND_REQ_WEEK_6,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_7    AS IND_REQ_WEEK_7,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_8    AS IND_REQ_WEEK_8,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_9    AS IND_REQ_WEEK_9,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_10   AS IND_REQ_WEEK_10,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_11   AS IND_REQ_WEEK_11,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_12   AS IND_REQ_WEEK_12,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_0      AS FIRM_REQ_WEEK_0,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_1      AS FIRM_REQ_WEEK_1,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_2      AS FIRM_REQ_WEEK_2,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_3      AS FIRM_REQ_WEEK_3,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_4      AS FIRM_REQ_WEEK_4,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_5      AS FIRM_REQ_WEEK_5,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_6      AS FIRM_REQ_WEEK_6,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_7      AS FIRM_REQ_WEEK_7,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_8      AS FIRM_REQ_WEEK_8,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_9      AS FIRM_REQ_WEEK_9,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_10     AS FIRM_REQ_WEEK_10,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_11     AS FIRM_REQ_WEEK_11,
  BS_MCBZ_TOT_IND_FIRM.IND_REQ_WK_12     AS FIRM_REQ_WEEK_12,


  OPEN_PO.OPEN_OP_WEEK_1 AS OPEN_OP_WEEK_0,                                                                                                                 AS OPEN_OP_WEEK_1,
  OPEN_PO.OPEN_OP_WEEK_2 AS OPEN_OP_WEEK_1,                                                                                                                         AS OPEN_OP_WEEK_2,
  OPEN_PO.OPEN_OP_WEEK_3 AS OPEN_OP_WEEK_2,                                                                                                                              AS OPEN_OP_WEEK_3,
  OPEN_PO.OPEN_OP_WEEK_4 AS OPEN_OP_WEEK_3,                                                                                                                              AS OPEN_OP_WEEK_4,
  OPEN_PO.OPEN_OP_WEEK_5 AS OPEN_OP_WEEK_4,                                                                                                                              AS OPEN_OP_WEEK_5,
  OPEN_PO.OPEN_OP_WEEK_6 AS OPEN_OP_WEEK_5,                                                                                                                              AS OPEN_OP_WEEK_6,
  OPEN_PO.OPEN_OP_WEEK_7 AS OPEN_OP_WEEK_6,                                                                                                                              AS OPEN_OP_WEEK_7,
  OPEN_PO.OPEN_OP_WEEK_8 AS OPEN_OP_WEEK_7,                                                                                                                              AS OPEN_OP_WEEK_8,
  OPEN_PO.OPEN_OP_WEEK_9 AS OPEN_OP_WEEK_8,                                                                                                                              AS OPEN_OP_WEEK_9,
  OPEN_PO.OPEN_OP_WEEK_10 AS OPEN_OP_WEEK_9,                                                                                                                             AS OPEN_OP_WEEK_10,
  OPEN_PO.OPEN_OP_WEEK_11 AS OPEN_OP_WEEK_10,                                                                                                                             AS OPEN_OP_WEEK_11,
  OPEN_PO.OPEN_OP_WEEK_12 AS OPEN_OP_WEEK_11,                                                                                                                             AS OPEN_OP_WEEK_12,
  OPEN_PO.OPEN_OP_WEEK_13 AS OPEN_OP_WEEK_12  
...
(
  ...
  BS_MCBZ_TOT_IND.MAT_DESC        AS MATERIAL_DES,
  ...
  BS_MCBZ_TOT_IND.IND_REQ_WK_0    AS TOT_REQ_WEEK_0,
  BS_MCBZ_TOT_IND.IND_REQ_WK_1    AS TOT_REQ_WEEK_1,
  BS_MCBZ_TOT_IND.IND_REQ_WK_2    AS TOT_REQ_WEEK_2,
  BS_MCBZ_TOT_IND.IND_REQ_WK_3    AS TOT_REQ_WEEK_3,
  BS_MCBZ_TOT_IND.IND_REQ_WK_4    AS TOT_REQ_WEEK_4,
  BS_MCBZ_TOT_IND.IND_REQ_WK_5    AS TOT_REQ_WEEK_5,
  BS_MCBZ_TOT_IND.IND_REQ_WK_6    AS TOT_REQ_WEEK_6,
  BS_MCBZ_TOT_IND.IND_REQ_WK_7    AS TOT_REQ_WEEK_7,
  BS_MCBZ_TOT_IND.IND_REQ_WK_8    AS TOT_REQ_WEEK_8,
  BS_MCBZ_TOT_IND.IND_REQ_WK_9    AS TOT_REQ_WEEK_9,
  BS_MCBZ_TOT_IND.IND_REQ_WK_10   AS TOT_REQ_WEEK_10,
  BS_MCBZ_TOT_IND.IND_REQ_WK_11   AS TOT_REQ_WEEK_11,
  BS_MCBZ_TOT_IND.IND_REQ_WK_12   AS TOT_REQ_WEEK_12,
  BS_MCBZ_TOT_IND.IND_REQ_WK_0    AS IND_REQ_WEEK_0,
  BS_MCBZ_TOT_IND.IND_REQ_WK_1    AS IND_REQ_WEEK_1,
  BS_MCBZ_TOT_IND.IND_REQ_WK_2    AS IND_REQ_WEEK_2,
  BS_MCBZ_TOT_IND.IND_REQ_WK_3    AS IND_REQ_WEEK_3,
  BS_MCBZ_TOT_IND.IND_REQ_WK_4    AS IND_REQ_WEEK_4,
  BS_MCBZ_TOT_IND.IND_REQ_WK_5    AS IND_REQ_WEEK_5,
  BS_MCBZ_TOT_IND.IND_REQ_WK_6    AS IND_REQ_WEEK_6,
  BS_MCBZ_TOT_IND.IND_REQ_WK_7    AS IND_REQ_WEEK_7,
  BS_MCBZ_TOT_IND.IND_REQ_WK_8    AS IND_REQ_WEEK_8,
  BS_MCBZ_TOT_IND.IND_REQ_WK_9    AS IND_REQ_WEEK_9,
  BS_MCBZ_TOT_IND.IND_REQ_WK_10   AS IND_REQ_WEEK_10,
  BS_MCBZ_TOT_IND.IND_REQ_WK_11   AS IND_REQ_WEEK_11,
  BS_MCBZ_TOT_IND.IND_REQ_WK_12   AS IND_REQ_WEEK_12,
  REQ_MCBZ_FIRM.IND_REQ_WK_0      AS FIRM_REQ_WEEK_0,
  REQ_MCBZ_FIRM.IND_REQ_WK_1      AS FIRM_REQ_WEEK_1,
  REQ_MCBZ_FIRM.IND_REQ_WK_2      AS FIRM_REQ_WEEK_2,
  REQ_MCBZ_FIRM.IND_REQ_WK_3      AS FIRM_REQ_WEEK_3,
  REQ_MCBZ_FIRM.IND_REQ_WK_4      AS FIRM_REQ_WEEK_4,
  REQ_MCBZ_FIRM.IND_REQ_WK_5      AS FIRM_REQ_WEEK_5,
  REQ_MCBZ_FIRM.IND_REQ_WK_6      AS FIRM_REQ_WEEK_6,
  REQ_MCBZ_FIRM.IND_REQ_WK_7      AS FIRM_REQ_WEEK_7,
  REQ_MCBZ_FIRM.IND_REQ_WK_8      AS FIRM_REQ_WEEK_8,
  REQ_MCBZ_FIRM.IND_REQ_WK_9      AS FIRM_REQ_WEEK_9,
  REQ_MCBZ_FIRM.IND_REQ_WK_10     AS FIRM_REQ_WEEK_10,
  REQ_MCBZ_FIRM.IND_REQ_WK_11     AS FIRM_REQ_WEEK_11,
  REQ_MCBZ_FIRM.IND_REQ_WK_12     AS FIRM_REQ_WEEK_12
FROM
  (SELECT BS_MCBZ_TOT.ID        AS ID,
    ...
    BS_MCBZ_TOT.MAT_DESC        AS MATERIAL_DES,
    ...
    BS_MCBZ_TOT.IND_REQ_WK_0    AS TOT_REQ_WEEK_0,
    BS_MCBZ_TOT.IND_REQ_WK_1    AS TOT_REQ_WEEK_1,
    BS_MCBZ_TOT.IND_REQ_WK_2    AS TOT_REQ_WEEK_2,
    BS_MCBZ_TOT.IND_REQ_WK_3    AS TOT_REQ_WEEK_3,
    BS_MCBZ_TOT.IND_REQ_WK_4    AS TOT_REQ_WEEK_4,
    BS_MCBZ_TOT.IND_REQ_WK_5    AS TOT_REQ_WEEK_5,
    BS_MCBZ_TOT.IND_REQ_WK_6    AS TOT_REQ_WEEK_6,
    BS_MCBZ_TOT.IND_REQ_WK_7    AS TOT_REQ_WEEK_7,
    BS_MCBZ_TOT.IND_REQ_WK_8    AS TOT_REQ_WEEK_8,
    BS_MCBZ_TOT.IND_REQ_WK_9    AS TOT_REQ_WEEK_9,
    BS_MCBZ_TOT.IND_REQ_WK_10   AS TOT_REQ_WEEK_10,
    BS_MCBZ_TOT.IND_REQ_WK_11   AS TOT_REQ_WEEK_11,
    BS_MCBZ_TOT.IND_REQ_WK_12   AS TOT_REQ_WEEK_12,
    REQ_MCBZ_IND.IND_REQ_WK_0   AS IND_REQ_WEEK_0,
    REQ_MCBZ_IND.IND_REQ_WK_1   AS IND_REQ_WEEK_1,
    REQ_MCBZ_IND.IND_REQ_WK_2   AS IND_REQ_WEEK_2,
    REQ_MCBZ_IND.IND_REQ_WK_3   AS IND_REQ_WEEK_3,
    REQ_MCBZ_IND.IND_REQ_WK_4   AS IND_REQ_WEEK_4,
    REQ_MCBZ_IND.IND_REQ_WK_5   AS IND_REQ_WEEK_5,
    REQ_MCBZ_IND.IND_REQ_WK_6   AS IND_REQ_WEEK_6,
    REQ_MCBZ_IND.IND_REQ_WK_7   AS IND_REQ_WEEK_7,
    REQ_MCBZ_IND.IND_REQ_WK_8   AS IND_REQ_WEEK_8,
    REQ_MCBZ_IND.IND_REQ_WK_9   AS IND_REQ_WEEK_9,
    REQ_MCBZ_IND.IND_REQ_WK_10  AS IND_REQ_WEEK_10,
    REQ_MCBZ_IND.IND_REQ_WK_11  AS IND_REQ_WEEK_11,
    REQ_MCBZ_IND.IND_REQ_WK_12  AS IND_REQ_WEEK_12
  FROM
    (SELECT RCCP_BASIC_IND.ID        AS ID,
      RCCP_BASIC_IND.MATERIAL        AS MATERIAL,
      RCCP_BASIC_IND.CATALOG_DASH    AS CATALOG_DASH,
      RCCP_BASIC_IND.PLANT           AS PLANT,
      RCCP_BASIC_IND.MAT_DESC        AS MATERIAL_DES,
      RCCP_BASIC_IND.MRP_CONTROLLER  AS MRP_CONTROLLER,
      RCCP_BASIC_IND.STRATEGY_GRP    AS STRATEGY_GRP,
      RCCP_BASIC_IND.SAFETY_STOCK    AS SAFETY_STOCK,
      RCCP_BASIC_IND.OH_QTY          AS OH_QTY,
      ...
      RCCP_BASIC_IND.TARGET_INV      AS TARGET_INV,
      RCCP_BASIC_IND.MAX_INV         AS MAX_INV,
      REQ_MCBZ_TOT.IND_REQ_WK_0      AS TOT_REQ_WEEK_0,
      REQ_MCBZ_TOT.IND_REQ_WK_1      AS TOT_REQ_WEEK_1,
      REQ_MCBZ_TOT.IND_REQ_WK_2      AS TOT_REQ_WEEK_2,
      REQ_MCBZ_TOT.IND_REQ_WK_3      AS TOT_REQ_WEEK_3,
      REQ_MCBZ_TOT.IND_REQ_WK_4      AS TOT_REQ_WEEK_4,
      REQ_MCBZ_TOT.IND_REQ_WK_5      AS TOT_REQ_WEEK_5,
      REQ_MCBZ_TOT.IND_REQ_WK_6      AS TOT_REQ_WEEK_6,
      REQ_MCBZ_TOT.IND_REQ_WK_7      AS TOT_REQ_WEEK_7,
      REQ_MCBZ_TOT.IND_REQ_WK_8      AS TOT_REQ_WEEK_8,
      REQ_MCBZ_TOT.IND_REQ_WK_9      AS TOT_REQ_WEEK_9,
      REQ_MCBZ_TOT.IND_REQ_WK_10     AS TOT_REQ_WEEK_10,
      REQ_MCBZ_TOT.IND_REQ_WK_11     AS TOT_REQ_WEEK_11,
      REQ_MCBZ_TOT.IND_REQ_WK_12     AS TOT_REQ_WEEK_12
    FROM
      (SELECT ID        AS ID,
        MATERIAL        AS MATERIAL,
        CATALOG_DASH    AS CATALOG_DASH,
