...
SELECT * FROM INV_SAP_RCCP_INDREQ WHERE ELEMENT_INDICATOR = 'TO';
...
SELECT ID,
  ...
  PLAN_OP_WEEK_11,
  PLAN_OP_WEEK_12
FROM VIEW_INV_SAP_RCCP_THU
WHERE UNIT NOT   IN ('IN')
AND KEY          <> 0
AND STRATEGY_GRP IN ('40');
...
SELECT BS_MCBZ_PO.ID                                                                                                                                                                                                                                                                                                                                                                                                                                AS ID,
  ...
  NVL(BS_MCBZ_PO.TOT_REQ_WEEK_0,0)-NVL(BS_MCBZ_PO.FIRM_REQ_WEEK_0,0)-NVL(BS_MCBZ_PO.IND_REQ_WEEK_0,0)                                                                                                                                                                                                                                                                                                                                                                                                                AS FIRM_REQ_WEEK_0,
  NVL(BS_MCBZ_PO.TOT_REQ_WEEK_1,0)-NVL(BS_MCBZ_PO.FIRM_REQ_WEEK_0,0)-NVL(BS_MCBZ_PO.IND_REQ_WEEK_1,0)                                                                                                                                                                                                                                                                                                                                                                                                                 AS FIRM_REQ_WEEK_1,
  NVL(BS_MCBZ_PO.TOT_REQ_WEEK_2,0)-NVL(BS_MCBZ_PO.FIRM_REQ_WEEK_0,0)-NVL(BS_MCBZ_PO.IND_REQ_WEEK_2,0)                                                                                                                                                                                                                                                                                                                                                                                                                 AS FIRM_REQ_WEEK_2,
  NVL(BS_MCBZ_PO.TOT_REQ_WEEK_3,0)-NVL(BS_MCBZ_PO.FIRM_REQ_WEEK_0,0)-NVL(BS_MCBZ_PO.IND_REQ_WEEK_3,0)                                                                                                                                                                                                                                                                                                                                                                                                                 AS FIRM_REQ_WEEK_3,
  NVL(BS_MCBZ_PO.TOT_REQ_WEEK_4,0)-NVL(BS_MCBZ_PO.FIRM_REQ_WEEK_0,0)-NVL(BS_MCBZ_PO.IND_REQ_WEEK_4,0)                                                                                                                                                                                                                                                                                                                                                                                                                 AS FIRM_REQ_WEEK_4,
  NVL(BS_MCBZ_PO.TOT_REQ_WEEK_5,0)-NVL(BS_MCBZ_PO.FIRM_REQ_WEEK_0,0)-NVL(BS_MCBZ_PO.IND_REQ_WEEK_5,0)                                                                                                                                                                                                                                                                                                                                                                                                                AS FIRM_REQ_WEEK_5,
  NVL(BS_MCBZ_PO.TOT_REQ_WEEK_6,0)-NVL(BS_MCBZ_PO.FIRM_REQ_WEEK_0,0)-NVL(BS_MCBZ_PO.IND_REQ_WEEK_6,0)                                                                                                                                                                                                                                                                                                                                                                                                                 AS FIRM_REQ_WEEK_6,
  NVL(BS_MCBZ_PO.TOT_REQ_WEEK_7,0)-NVL(BS_MCBZ_PO.FIRM_REQ_WEEK_0,0)-NVL(BS_MCBZ_PO.IND_REQ_WEEK_7,0)                                                                                                                                                                                                                                                                                                                                                                                                                 AS FIRM_REQ_WEEK_7,
  NVL(BS_MCBZ_PO.TOT_REQ_WEEK_8,0)-NVL(BS_MCBZ_PO.FIRM_REQ_WEEK_0,0)-NVL(BS_MCBZ_PO.IND_REQ_WEEK_8,0)                                                                                                                                                                                                                                                                                                                                                                                                                 AS FIRM_REQ_WEEK_8,
  NVL(BS_MCBZ_PO.TOT_REQ_WEEK_9,0)-NVL(BS_MCBZ_PO.FIRM_REQ_WEEK_0,0)-NVL(BS_MCBZ_PO.IND_REQ_WEEK_9,0)                                                                                                                                                                                                                                                                                                                                                                                                                 AS FIRM_REQ_WEEK_9,
  NVL(BS_MCBZ_PO.TOT_REQ_WEEK_10,0)-NVL(BS_MCBZ_PO.FIRM_REQ_WEEK_0,0)-NVL(BS_MCBZ_PO.IND_REQ_WEEK_10,0)                                                                                                                                                                                                                                                                                                                                                                                                                AS FIRM_REQ_WEEK_10,
  NVL(BS_MCBZ_PO.TOT_REQ_WEEK_11,0)-NVL(BS_MCBZ_PO.FIRM_REQ_WEEK_0,0)-NVL(BS_MCBZ_PO.IND_REQ_WEEK_11,0)                                                                                                                                                                                                                                                                                                                                                                                                                AS FIRM_REQ_WEEK_11,
  NVL(BS_MCBZ_PO.TOT_REQ_WEEK_12,0)-NVL(BS_MCBZ_PO.FIRM_REQ_WEEK_0,0)-NVL(BS_MCBZ_PO.IND_REQ_WEEK_12,0)                                                                                                                                                                                                                                                                                                                                                                                                                AS FIRM_REQ_WEEK_12,
  ...
  FROM
    ...
    FROM
      ...
      FROM
        ...
        LEFT JOIN
          ...
          FROM INV_SAP_RCCP_INDREQ_THU WHERE ELEMENT_INDICATOR = 'TO'
          GROUP BY PLANT,
            MATERIAL
          )REQ_MCBZ_TOT
    ...
    LEFT JOIN
      (SELECT MATERIAL
        ...
        PLANT,
        MATERIAL,
        0  AS FIRM_REQ_WEEK_0,
        0  AS FIRM_REQ_WEEK_1,
        0  AS FIRM_REQ_WEEK_2,
        0  AS FIRM_REQ_WEEK_3,
        0  AS FIRM_REQ_WEEK_4,
        0  AS FIRM_REQ_WEEK_5,
        0  AS FIRM_REQ_WEEK_6,
        0  AS FIRM_REQ_WEEK_7,
        0  AS FIRM_REQ_WEEK_8,
        0  AS FIRM_REQ_WEEK_9,
        0 AS FIRM_REQ_WEEK_10,
        0 AS FIRM_REQ_WEEK_11,
        0 AS FIRM_REQ_WEEK_12
      FROM INV_SAP_RCCP_INDREQ_THU      
      )REQ_MCBZ_FIRM
