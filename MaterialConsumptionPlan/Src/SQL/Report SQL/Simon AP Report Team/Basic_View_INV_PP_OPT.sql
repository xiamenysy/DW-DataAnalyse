...
1.08 * SS + greatest(50*56/7,1,41)
= 1.08*86 + 50*8
= 93 + 400 = 493


SELECT * FROM INV_SAP_PP_OPTIMIZATION WHERE PLANTID = '5040' AND 
MATERIALID IN (
'PN-D165431'
)
...
WHERE MATERIAL      = 'PN-162604'
AND PLANT = '5040'
GROUP BY MATL_TYPE,MAX_INV

SELECT * FROM VIEW_INV_SAP_PP_OPT_X WHERE ID = '100CX12KF10_5070'
...
SELECT * FROM INV_SAP_PP_OPT_X WHERE MATERIAL = '100CX12KF10' AND PLANT = '5070'
