...
SELECT SVD_V_O.ID                   AS ID,
  ...
  SVD_V_O.CATALOG_DASH              AS CATALOG_DASH,
  SVD_V_O.PLANT                     AS PLANT,
  SVD_V_O.VENDOR                    AS VENDOR,
  SVD_V_O.BU                        AS BU,
  SVD_V_O.LEAD_TIME                 AS LEAD_TIME,
  SVD_V_O.STRATEGY_GRP              AS STRATEGY_GRP,
  SVD_V_O.MRP_TYPE                  AS MRP_TYPE,
  SVD_V_O.SAFETY_STOCK              AS SAFETY_STOCK,
  SVD_V_O.AVG13_USAGE_QTY           AS AVG13_USAGE_QTY,
  ...
  SVD_V_O.PASS_DUE_QTY              AS PASS_DUE_QTY,
  SVD_V_O.LT_OPEN_QTY               AS LT_OPEN_QTY,
  SVD_V_O.LT_WEEKS13_OPEN_QTY       AS LT_WEEKS13_OPEN_QTY,
  SVD_V_O.OUT_WEEKS13_OPEN_QTY      AS OUT_WEEKS13_OPEN_QTY,
...
SELECT SVD_BASIC.ID,
  ...
  SVD_COMM.PLANNER,
  SVD_COMM.COMMENTS,
  TO_CHAR(SVD_COMM.LAST_UPDATE_DATE,'MM/DD/YYYY')
FROM
  (SELECT ID,
    MATERIAL,
    CATALOG_DASH,
  ...
  FROM VIEW_INV_SAP_SVD_REPORT_U
  WHERE CHECK_KEY  <> 0
