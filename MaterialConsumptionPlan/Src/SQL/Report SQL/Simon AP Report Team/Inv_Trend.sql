...
SELECT * FROM INV_SAP_INV_REC WHERE REC_DATE between SYSDATE - 1 and sysdate;

INSERT INTO INV_SAP_INV_REC(INV_ID,
ID,
REC_DATE,
PLANTID,
MATERIAL,
...
sysdate - 7 ||'_'||ID AS INV_ID,
ID,
sysdate - 7 AS REC_DATE,
PLANTID,
MATERIAL,
CATALOG_DASH,
SAFETY_STOCK,
...
MAX_INV_VAL,
OVER_MAX_VAL
FROM INV_SAP_INV_REC WHERE REC_DATE between SYSDATE - 7 and sysdate - 6;

SELECT * FROM INV_SAP_INV_REC where inv_id = '13-OCT-14_1492-WTS3 B_5140';
DROP TABLE INV_SAP_INV_REC_1020;
CREATE TABLE INV_SAP_INV_REC_1020 AS SELECT * FROM INV_SAP_INV_REC;
