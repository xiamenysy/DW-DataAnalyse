...
SELECT * FROM DWQ$LIBRARIAN.INV_SAP_INVENTORY_BY_PLANT@ROCKWELL_DBLINK WHERE MATERIALID = 'PN-70595' AND PLANTID = '5040';

SELECT *
FROM DWQ$LIBRARIAN.INV_SAP_IO_INPUTS_DAILY@ROCKWELL_DBLINK
WHERE materialid = '80026-044-06-R'
AND PLANTID     = '5040';
