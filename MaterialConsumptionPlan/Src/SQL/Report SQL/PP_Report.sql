...
SELECT * FROM INV_SAP_PP_REPORT_WEEKLY_Joyse;
DROP TABLE INV_SAP_PP_REPORT_WEEKLY_Joyse;
CREATE TABLE INV_SAP_PP_REPORT_WEEKLY_Joyse AS
SELECT 
    PROC_TYPE,
    MATERIALID,
    PLANTID,
    ...
    MATL_TYPE_MTART
FROM DWQ$LIBRARIAN.INV_SAP_PP_OPTIMIZATION@ROCKWELL_DBLINK
WHERE PLANTID IN ('5041', '5051', '5101', '5111', '5121', '5161', '5191', '5201','5071','5141');
