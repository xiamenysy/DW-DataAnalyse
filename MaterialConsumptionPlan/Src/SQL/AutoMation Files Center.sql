...
--Daily Jobs
	...
	2.3 Job Name: Job_Weekly_INV_SO_HST
		Job Time: 10:30 AM
    ...
    SELECT distinct MATERIALID from INV_SAP_SALES_HST;
	...
	2.19 Job Name: Job_Weekly_BK_STI
		Job Time: 8:00 AM
	...
	2.20 Job Name: Job_Weekly_SALEHST_TO_OTABLE
		Job Time: 8:30 AM
		Job Repeat Frequency: Weekly
		Job Procedure:
		DECLARE
			TRUNCATE_SALEHST_TABLE  VARCHAR2(1000);
			INSERT_TABLE_SALEHST  VARCHAR2(1000);
		BEGIN
			TRUNCATE_SALEHST_TABLE   := 'TRUNCATE TABLE INV_SAP_SVD_REPORT';
			INSERT_TABLE_SALEHST := 'INSERT INTO INV_SAP_SVD_REPORT SELECT * FROM VIEW_INV_SAP_SVD_REPORT';
			EXECUTE IMMEDIATE TRUNCATE_SALEHST_TABLE;
			EXECUTE IMMEDIATE INSERT_TABLE_SALEHST;
		END;   		
	...
	2.11 Job Name: Job_Monthly_INV_PP_CATA
		Job Time: 12:00 AM SATDAY
	...
	2.12 Job Name: Job_Monthly_INV_SHIPSOLD
