...
1. Oracle Client Setup
	...
	1.3 Ini Setup
		...
		SELECT * FROM DWQ$LIBRARIAN.INV_SAP_PP_FRCST_PBIM_PBED@ROCKWELL_DW_DBLINK;
...
2. Oracle Job Setup
	2.1 Job Name: Job_Daily_INV_PP_OPT
		...
		BEGIN
		  DROP_TABLE_PP_OPTIMIZATION   := 'TRUNCATE TABLE INV_SAP_PP_OPTIMIZATION';
	...
	2.2 Job Name: Job_Daily_INV_SO_OPEN
		...
		BEGIN
		  DROP_TABLE_OPEN_SALES   := 'TRUNCATE TABLE INV_SAP_SALES_VBAK_VBAP_VBUP';
		  CREATE_TABLE_OPEN_SALES := 'INSERT INTO INV_SAP_SALES_VBAK_VBAP_VBUP 
			SELECT * FROM DWQ$LIBRARIAN.INV_SAP_SALES_VBAK_VBAP_VBUP@ROCKWELL_DW_DBLINK';
	...
	2.11 Job Name: Job_Monthly_INV_SHIPSOLD
      ...
      INSERT_INV_SHIPSOLD_B  VARCHAR2(1000);
		BEGIN
		  DROP_TABLE_INV_SHIPSOLD   := 'TRUNCATE TABLE INV_SAP_SHIP_SOLD_TO_PARTYID';
		  CREATE_TABLE_INV_SHIPSOLD_DW := 'INSERT INTO INV_SAP_SHIP_SOLD_TO_PARTYID 
      SELECT * FROM DWQ$LIBRARIAN.INV_SAP_SHIP_SOLD_TO_PARTYID@ROCKWELL_DW_DBLINK';
      CREATE_TABLE_INV_SHIPSOLD_LO := 'INSERT INTO INV_SAP_SHIP_SOLD_TO_PARTYID
	...
	2.12 Job Name: Job_Daily_PP_TABLE
		...
		BEGIN
		  ...
		  CREATE_TABLE_INV_PP_TABLE := 'CREATE TABLE INV_SAP_PP_OPT_X AS SELECT * FROM VIEW_INV_SAP_PP_OPT_X';
  ...
  2.13 Job Name: Job_Monthly_PLANT_SOG
	...
	2.14 Job Name: Job_Daily_FCSTAT55_TABLE
		Job Time: 7:10 AM
		Job Repeat Frequency: Daily
		Job Procedure: 
		TRUNCATE TABLE INV_SAP_FC55_STATS;
		INSERT INTO INV_SAP_FC55_STATS SELECT * FROM VIEW_INV_SAP_FC55_STATS;
  ...
  2.14.1 Job Name: Job_Daily_FCSTAT00_TABLE
		Job Time: 7:10 AM
		Job Repeat Frequency: Daily
		Job Procedure: 
		TRUNCATE TABLE INV_SAP_FC00_STATS;
		INSERT INTO INV_SAP_FC00_STATS SELECT * FROM VIEW_INV_SAP_FC00_STATS;
	...
	2.15 Job Name: Job_Daily_BLSO_TABLE
		...
		Job Repeat Frequency: Daily
		Job Procedure:
		TRUNCATE TABLE INV_SAP_BACKLOG_SO;
		INSERT INTO INV_SAP_BACKLOG_SO SELECT * FROM VIEW_INV_SAP_BACKLOG_SO;
	...
	2.16 Job Name: Job_Daily_BLINV_TABLE
		...
		Job Repeat Frequency: Daily
		Job Procedure:
    TRUNCATE TABLE INV_SAP_BACKLOG_INV;
    INSERT INTO INV_SAP_BACKLOG_INV SELECT * FROM VIEW_INV_SAP_BACKLOG_INV;
	...
	2.17 Job Name: Job_Daily_BLPO_TABLE
		...
		Job Repeat Frequency: Daily
		Job Procedure:
    TRUNCATE TABLE INV_SAP_BACKLOG_PO;
    INSERT INTO INV_SAP_BACKLOG_PO SELECT * FROM VIEW_INV_SAP_BACKLOG_PO;

    DROP TABLE INV_SAP_BACKLOG_PO;
    CREATE TABLE INV_SAP_BACKLOG_PO AS SELECT * FROM VIEW_INV_SAP_BACKLOG_PO;
	...
	2.20 Job Name: Job_Daily_SVD_TO_OTABLE
		Job Time: 8:15 AM
		Job Repeat Frequency: Daily
		Job Procedure:
    CREATE TABLE INV_SAP_SVD_REPORT AS SELECT * FROM VIEW_INV_SAP_SVD_REPORT;
    TRUNCATE TABLE INV_SAP_SVD_REPORT;
    INSERT INTO INV_SAP_SVD_REPORT SELECT * FROM VIEW_INV_SAP_SVD_REPORT;
