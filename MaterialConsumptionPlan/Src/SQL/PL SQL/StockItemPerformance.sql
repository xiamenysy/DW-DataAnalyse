...
select * from INV_SAP_SALES_HST where MATERIALID = '22B-A2P3N104 A' AND PLANTID = '5070';
---Upload History Data
...
LEFT JOIN
  ...
  FROM
    ...
    AND REQUIREDDELIVERYDATE < SYSDATE + 90 AND SALESDOCTYPE IN ('ZOR1','ZOR5') AND OPENQTY > 0 AND MATERIALID = '22B-A2P3N104 A'
    GROUP BY 
    MATERIALID,
    PLANTID
    )BACKLOG_OPEN
