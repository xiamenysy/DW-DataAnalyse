...
SELECT * FROM STOCK_ITEM_STATUS_BY_BU_WEEK where id = '19-MAY-14_5200_CCT-TECHNICAL SUPPORT CENTERS';
...
SELECT * FROM STOCK_ITEM_STATUS_BY_ITEM WHERE ID = '19-May-14_5040_SFC-SAFETY COMPONENTS_440N-Z21SS2A A';
...
SELECT * FROM STOCK_ITEM_STATUS_BY_BU_WEEK WHERE plantid = 5110;
